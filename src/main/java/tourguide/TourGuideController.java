...
public class TourGuideController {
    ...
    public String getLocation(@RequestParam String userName) {
        ...
        VisitedLocation visitedLocation = this.tourGuideService.getUserLocation(this.getUser(userName));
    ...
    public String getNearbyAttractions(@RequestParam String userName) {
        ...
        VisitedLocation visitedLocation = this.tourGuideService.getUserLocation(this.getUser(userName));
        return JsonStream.serialize(this.tourGuideService.getNearByAttractions(visitedLocation));
    }
